...
public class Fragment9 extends android.support.v4.app.Fragment implements XListView.IXListViewListener{

    private View view;
    private XListView lv;
    private String url="http://v.juhe.cn/toutiao/index?key=22a108244dbb8d1f49967cd74a0c144d&type=caijing";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        netWorkInfoUtils.verify(getActivity(), new NetWorkInfoUtils.NetWork() {
            ...
            public void netUnVisible() {
                ...
                NetNews select = dao.select("caijing");
